    ...
    <>
      <div className="mt-3 p-2 rounded-xl bg-slate-950 border border-slate-800 block w-fit mx-auto max-w-full">
        <div className="relative group cursor-pointer" onClick={() => setIsZoomed(true)}>
          ...
          />
          <div className="absolute inset-0 bg-slate-100/60 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center text-white text-xs gap-1.5 font-semibold">
      ...
      {isZoomed && (
        <div
          className="fixed inset-0 z-50 bg-slate-100/90 backdrop-blur-md flex items-center justify-center p-4"
