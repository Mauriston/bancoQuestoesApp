...
export const InactivePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 text-center">
      <div className="w-16 h-16 rounded-2xl bg-red-500/20 text-red-400 border border-red-500/30 flex items-center justify-center mb-4">
        <ShieldAlert className="w-8 h-8" />
      </div>
      <h1 className="text-xl font-bold text-white mb-2">Usuário Inativo</h1>
      <p className="text-xs text-slate-400 max-w-sm mb-6">
...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 text-center">
      ...
      <h2 className="text-base font-bold text-white mb-2">Página Não Encontrada</h2>
      <p className="text-xs text-slate-400 max-w-sm mb-6">
