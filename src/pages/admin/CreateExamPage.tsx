  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 border-b border-slate-800 pb-4">
        <h1 className="text-xl font-bold text-slate-100 flex items-center gap-2 shrink-0">
      ...
      {step === 1 && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4 text-xs">
          <h2 className="text-sm font-bold text-slate-100 mb-2">Etapa 1: Dados e Configurações da Prova</h2>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-6">
            ...
            >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {(searchQuery || areaFilter || themeFilterIds.length > 0 || selectedSourceExams.length > 0 || showOnlySelected) && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-slate-400 hover:text-slate-100 text-[11px] font-semibold justify-center"
                    >
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 space-y-3 mt-4">
                <h3 className="text-xs font-bold text-slate-100">Temas das Questões Selecionadas</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-700 shrink-0"
                    >
      ...
      {step === 3 && !isEditMode && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4 text-xs">
          <h2 className="text-sm font-bold text-slate-100 mb-2">Etapa 3: Atribuir a Prova aos Candidatos</h2>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-2 cursor-pointer p-3 rounded-xl border border-slate-800 bg-slate-950">
              ...
              />
              <div>
                <strong className="text-slate-100 block">Atribuir a TODOS os usuários ativos ({activeUsers.length})</strong>
            ...
            <label className="flex items-center gap-2 cursor-pointer p-3 rounded-xl border border-slate-800 bg-slate-950">
              ...
              />
              <div>
                <strong className="text-slate-100 block">Selecionar Usuários Específicos</strong>
      ...
      {step === 4 && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4 text-xs">
          ...
          <div className="space-y-2 text-slate-300 bg-slate-950 p-4 rounded-xl border border-slate-800">
            <p>• Nome da Prova: <strong className="text-slate-100">{name}</strong></p>
