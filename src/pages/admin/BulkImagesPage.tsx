  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
        <h3 className="text-sm font-bold text-[#050f41] mb-2">1. Qual a fonte dessas imagens?</h3>
        ...
        <input
          ...
          disabled={processing}
          className="w-full max-w-md bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-[#050f41] focus:outline-none focus:border-cyan-500 disabled:opacity-60"
        />
      ...
      {entries.length > 0 && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h3 className="text-sm font-bold text-[#050f41]">3. Conferir e importar</h3>
              ...
              {results.map((r, i) => (
                <div key={`${r.fileName}-${i}`} className="flex items-start gap-2.5 px-3 py-2 text-xs">
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-[#050f41] truncate">{r.fileName}</p>
