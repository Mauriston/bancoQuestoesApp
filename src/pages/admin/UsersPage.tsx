      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 rounded-xl pl-9 pr-3 py-2 text-xs text-[#05413b] placeholder-slate-500 focus:outline-none focus:border-cyan-500"
          />
        </div>
            ...
            <table className="w-full text-left text-xs text-slate-300">
              ...
              <tbody className="divide-y divide-slate-800/80">
                {filtered.map((u) => (
                  ...
                  >
                    <td className="p-3.5 font-semibold text-[#05413b]">
            ...
            <form onSubmit={handleCreateUser} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-[#05413b] focus:outline-none focus:border-cyan-500"
                />
              </div>
